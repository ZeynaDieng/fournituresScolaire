// server/api/airtable/promotions.get.ts - VERSION TEMPORAIRE AVEC FALLBACK
export default defineEventHandler(async (event) => {
  console.log("🔄 Utilisation des données de fallback pour les promotions...");

  // Données de fallback directes
