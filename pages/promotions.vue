<template>
  <div class="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50">
    <!-- Hero Section -->
    <div class="relative overflow-hidden bg-gradient-to-r from-primary-green to-green-500 text-white">
      <div class="absolute inset-0 bg-black opacity-10"></div>
      <div class="relative max-w-7xl mx-auto px-4 py-16">
        <div class="text-center">
          <h1 class="text-4xl md:text-6xl font-bold mb-4 bg-gradient-to-r from-yellow-300 to-orange-300 bg-clip-text text-transparent">
             Promotions de Rentrée
          </h1>
          <p class="text-xl md:text-2xl text-purple-100 mb-8">Des offres exceptionnelles pour bien démarrer l'année scolaire</p>
          <div class="inline-flex items-center bg-white/20 backdrop-blur-sm rounded-full px-6 py-3 text-sm">
    ...
    <div class="max-w-7xl mx-auto px-4 py-12">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
        <div 
          ...
          :class="promo.featured ? 'ring-4 ring-yellow-400 ring-opacity-50' : ''"
        >
          <!-- Badge Featured -->
          <div v-if="promo.featured" class="absolute top-4 left-4 z-10">
            <div class="bg-gradient-to-r from-yellow-400 to-orange-500 text-white px-3 py-1 rounded-full text-xs font-bold animate-pulse">
          ...
          <div class="absolute top-4 right-4 z-10">
            <div class="bg-gradient-to-r from-red-500 to-pink-500 text-white px-3 py-1 rounded-full text-sm font-bold transform rotate-3">
              -{{ promo.discount }}%
            </div>
          </div>
          ...
          <div class="p-8">
            <!-- Icon -->
            <div class="text-6xl mb-4 text-center transform group-hover:scale-110 transition-transform duration-300">
              {{ promo.icon }}
            </div>
            ...
            <div class="text-center mb-6">
              <div class="flex items-center justify-center space-x-2 mb-2">
                ...
                <span class="text-3xl font-bold bg-gradient-to-r from-red-500 to-pink-500 bg-clip-text text-transparent">
                  {{ promo.price }} CFA
                </span>
              </div>
              <div class="text-sm text-green-600 font-medium">
                <i class="fas fa-tag mr-1"></i>Vous économisez {{ promo.originalPrice - promo.price }} CFA
              </div>
            </div>

            <!-- Countdown -->
            <AppCountdown :endTime="promo.endTime" class="mb-6" />
          ...
          <!-- Decorative Elements -->
          <div class="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-green-600 to-green-600 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500"></div>
        </div>
      </div>
      ...
      <div class="mt-16 bg-gradient-to-r from-gray-50 to-gray-100 rounded-3xl p-8">
        <div class="text-center mb-8">
          <h3 class="text-3xl font-bold text-gray-800 mb-4">Pourquoi nous choisir ?</h3>
          <p class="text-gray-600 text-lg">Des milliers d'étudiants nous font confiance</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div class="text-center">
            ...
            <h4 class="font-bold text-lg text-gray-800 mb-2">Qualité Garantie</h4>
...
useSeoMeta({
  ...
  description: 'Découvrez nos offres exceptionnelles pour la rentrée scolaire. Jusqu\'à 50% de réduction sur tous vos produits essentiels.',
  ogDescription: 'Découvrez nos offres exceptionnelles pour la rentrée scolaire. Jusqu\'à 50% de réduction sur tous vos produits essentiels.',
...
const promotions = ref([
  { 
    ...
    description: 'Lot de 10 cahiers grand format avec couverture rigide et papier de qualité supérieure',
    price: 4000, 
    originalPrice: 5000,
    discount: 20,
    icon: '📚',
  ...
  { 
    ...
    description: 'Tout le nécessaire pour le lycée : cahiers, classeurs, trousse garnie, calculatrice',
    price: 15000, 
    originalPrice: 20000,
    discount: 25,
    icon: '🎒',
  ...
  { 
    ...
    description: 'Set complet pour les cours de mathématiques : compas, équerre, rapporteur, règles',
    price: 2500, 
    originalPrice: 3500,
    discount: 30,
    icon: '📐',
  ...
  { 
    ...
    description: 'Tout pour les cours d\'arts plastiques : crayons, feutres, peinture, pinceaux',
    price: 6000, 
    originalPrice: 8500,
    discount: 35,
    icon: '🎨',
  ...
  { 
    ...
    description: 'L\'essentiel pour l\'université : classeurs, intercalaires, bloc-notes, stylos',
    price: 8500, 
    originalPrice: 12000,
    discount: 30,
    icon: '🎓',
  ...
  { 
    ...
    description: 'Idéal pour l\'école primaire : cahiers, crayons, gommes, taille-crayons',
    price: 3200, 
    originalPrice: 4500,
    discount: 28,
    icon: '✏️',
