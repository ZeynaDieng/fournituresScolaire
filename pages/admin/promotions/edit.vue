...
// Initialiser le formulaire avec les données de la promotion
watch(
  () => props.promotion,
  (promotion) => {
    if (promotion) {
      form.value = {
        ...
        Icon: promotion.Icon || "",
        "Local ID": promotion["Local ID"] || "",
        Trending: promotion.Trending || false,
...
async function submit() {
  await $fetch(`/api/admin/promotions/${props.promotion.id}`, {
    method: "PUT",
    body: form.value,
  });
  emit("refresh");
