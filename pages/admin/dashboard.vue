    ...
    <div class="bg-white shadow-sm border-b">
      <div class="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between">
          <div>
            <h1 class="text-2xl font-bold text-gray-900">Dashboard Avancé</h1>
          ...
          <div class="px-4 py-5 sm:p-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <QuickActionButton
                ...
                icon="orders"
                color="purple"
                @click="navigateTo('/admin/orders-airtable')"
              />
              <QuickActionButton
                title="Promotions"
                description="Gérer les promos"
                icon="tag"
                color="orange"
...
// SEO
useHead({
  title: "Dashboard Avancé - Admin EduShop",
  meta: [
    {
      name: "description",
