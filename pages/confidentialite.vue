          ...
          <div class="prose max-w-none">
            <section class="mb-8">
              ...
              <p class="text-gray-700">
                ...
                dans cette politique de confidentialité. Nous vous encourageons
                à lire attentivement cette politique pour comprendre nos
            ...
            <section class="mb-8">
              ...
              <h3 class="font-medium text-gray-800 mt-4 mb-2">
              ...
              <ul class="list-disc pl-6 text-gray-700 space-y-1">
                ...
                <li>
                  Données de paiement (traitées de manière sécurisée par nos
                  prestataires de paiement)
                </li>
                <li>Historique des commandes et préférences d'achat</li>
                <li>
                  Contenu des communications (emails, demandes d'assistance)
                </li>
              </ul>
              ...
              <ul class="list-disc pl-6 text-gray-700 space-y-1">
                ...
                <li>
                  Données d'utilisation (fréquence d'utilisation,
                  fonctionnalités utilisées)
                </li>
                <li>
                  Données de localisation (si activées dans les paramètres de
                  votre appareil)
                </li>
                <li>
                  ...
                  <NuxtLink
                    ...
                    >Politique relative aux cookies</NuxtLink
                  >)
                </li>
              </ul>
            </section>
            ...
            <section class="mb-8">
              ...
              <ul class="list-disc pl-6 text-gray-700 space-y-1">
                <li>
                  Prestataires de services (livraison, paiement, hébergement)
                </li>
                <li>
              ...
              <p class="text-gray-700 mt-4">
                Nous exigeons de tous nos partenaires qu'ils protègent vos
                données conformément à la législation en vigueur.
              </p>
            </section>
            ...
            <section class="mb-8">
              ...
              <p class="text-gray-700 mb-4">
                Conformément à la loi n°2008-12 du 25 janvier 2008, vous
              ...
              <ul class="list-disc pl-6 text-gray-700 space-y-1">
                ...
                <li>
                  Définir des directives relatives au sort de vos données après
                  votre décès
                </li>
              </ul>
              <p class="text-gray-700 mt-4">
                Pour exercer ces droits ou pour toute question concernant la
              ...
              <p class="text-gray-700 mt-2">
                ...
                d'un mois à compter de sa réception. Ce délai peut être prolongé
                de deux mois, en fonction de la complexité et du nombre de
                demandes.
              </p>
            </section>
            ...
            <section class="mb-8">
              ...
              <p class="text-gray-700">
                ...
                nécessaire pour fournir nos services et pour nous conformer à
                nos obligations légales. Les critères que nous utilisons pour
                déterminer la durée de conservation comprennent :
              </p>
              <ul class="list-disc pl-6 text-gray-700 mt-2 space-y-1">
                <li>La durée de notre relation commerciale</li>
                <li>
                  Les obligations légales de conservation (par exemple, pour les
                  factures)
                </li>
                <li>Les délais de prescription légaux</li>
                <li>
            ...
            <section class="mb-8">
              ...
              <p class="text-gray-700">
                ...
                pour refléter les évolutions de nos pratiques ou pour nous
                conformer aux exigences légales. Nous vous informerons de toute
                modification significative en publiant la nouvelle politique sur
                notre site et en mettant à jour la date de « Dernière mise à
...
// SEO et métadonnées
useHead({
  title: "Politique de Confidentialité - EduShop",
  meta: [
    {
      name: "description",
      content:
        "Découvrez comment EduShop protège vos données personnelles et respecte votre vie privée conformément à la réglementation en vigueur.",
    },
  ],
});
</script>
