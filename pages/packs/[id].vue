<template>
  <div class="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 py-16 px-4">
        ...
        <div class="lg:col-span-7">
          <div class="relative">
            ...
            <div v-if="pack?.isPromotion" class="absolute -top-4 -left-4 z-20">
              <div class="relative">
                <div class="bg-gradient-to-r from-red-500 to-rose-600 text-white px-6 py-3 rounded-2xl shadow-xl transform -rotate-3">
            ...
            <!-- Image principale -->
            <div class="group relative overflow-hidden rounded-3xl bg-gradient-to-br from-slate-100 to-slate-200 aspect-[4/3] shadow-2xl">
            ...
            <div class="absolute bottom-6 left-6 flex gap-3">
              <div class="bg-white/90 backdrop-blur-sm rounded-full px-4 py-2 shadow-lg">
                <div class="flex items-center gap-2">
                  ...
                  <span class="text-sm font-medium text-slate-700">Qualité Premium</span>
                </div>
              </div>
              <div class="bg-white/90 backdrop-blur-sm rounded-full px-4 py-2 shadow-lg">
                <div class="flex items-center gap-2">
          ...
          <div class="sticky top-8">
            ...
            <div class="mb-8">
              <div class="flex items-center gap-3 mb-4">
                <div class="px-3 py-1 bg-emerald-100 text-emerald-800 rounded-full text-sm font-medium">
                  Pack Éducatif
                </div>
                <div class="flex items-center gap-1">
                  <span class="text-sm text-slate-500">SKU:</span>
                  <span class="text-sm font-mono text-slate-600">{{ pack?.id }}</span>
                </div>
              </div>
            ...
            <!-- Pricing -->
            <div class="bg-gradient-to-br from-slate-50 to-white border border-slate-200 rounded-2xl p-6 mb-8">
            ...
            <div class="mb-8">
              ...
              <div class="space-y-4">
                ...
                >
                  <div class="flex-shrink-0 w-6 h-6 bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-full flex items-center justify-center mt-0.5">
                    <svg class="w-3.5 h-3.5 text-white" fill="currentColor" viewBox="0 0 20 20">
                      <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                    </svg>
                  </div>
                  <span class="text-slate-700 font-medium group-hover:text-emerald-800 transition-colors">
                    {{ item }}
                  </span>
                </div>
              </div>
            ...
            <div class="space-y-4">
              ...
              <div class="grid grid-cols-2 gap-3">
                <button class="flex items-center justify-center gap-2 py-3 px-4 border-2 border-slate-200 hover:border-emerald-300 text-slate-700 hover:text-emerald-700 font-medium rounded-xl transition-all duration-300 hover:bg-emerald-50">
                  <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const pack = computed(() => productsStore.packs.find(p => p.id === route.params.id))
...
function addToCart(pack: any) {
  ...
  toast.add({
    ...
    description: `${pack.name} a été ajouté à votre panier`,
    color: 'emerald',
