<template>
  <div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-2xl mx-auto px-4">
      <h1 class="text-3xl font-bold text-center mb-8">Test WhatsApp</h1>

      <div class="bg-white p-6 rounded-lg shadow">
        <h2 class="text-xl font-semibold mb-4">Données de test</h2>
...
const testWhatsApp = async () => {
  try {
    console.log("🧪 Test WhatsApp avec données:", testData.value);

    // Formater le message
    const message = formatWhatsAppOrderMessage(testData.value);
