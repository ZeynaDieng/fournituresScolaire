  ...
  <div class="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100">
    ...
    <div v-if="pending" class="container mx-auto px-4 py-16">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
        <div class="space-y-6">
          <div class="aspect-square bg-slate-200 rounded-3xl animate-pulse"></div>
          <div class="grid grid-cols-4 gap-4">
            <div v-for="i in 4" :key="i" class="aspect-square bg-slate-200 rounded-2xl animate-pulse"></div>
          </div>
        </div>
        <div class="space-y-6">
    ...
    <div v-else-if="product" class="container mx-auto px-4 py-8 lg:py-16">
      ...
      <nav class="flex items-center space-x-2 text-sm text-slate-500 mb-8">
        <NuxtLink to="/" class="hover:text-emerald-600 transition-colors">Accueil</NuxtLink>
        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
          <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 111.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd" />
        </svg>
        <NuxtLink to="/products" class="hover:text-emerald-600 transition-colors">Produits</NuxtLink>
        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
          <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 111.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd" />
        </svg>
        ...
        <div class="lg:col-span-7">
          <div class="space-y-6">
            ...
            <div class="relative group">
              <!-- Promotion Badge -->
              <div v-if="product.isPromotion" class="absolute top-6 left-6 z-20">
                <div class="bg-gradient-to-r from-red-500 to-rose-600 text-white px-4 py-3 rounded-2xl shadow-xl">
              ...
              <div class="absolute top-6 right-6 z-20">
                ...
                >
                  <svg class="w-6 h-6 transition-transform group-hover/heart:scale-110" :fill="isWishlisted ? 'currentColor' : 'none'" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <!-- Main Product Image -->
              <div class="aspect-square bg-gradient-to-br from-slate-50 to-slate-100 rounded-3xl overflow-hidden shadow-2xl">
                <img 
            ...
            <div class="grid grid-cols-4 gap-4">
              <button 
                ...
                :class="{
                  'border-emerald-500 shadow-lg': selectedImage === image || (!selectedImage && index === 0),
                  'border-slate-200': selectedImage !== image && (selectedImage || index !== 0)
                }"
              >
                <img 
                  :src="image" 
            ...
            <!-- Product Features -->
            <div class="bg-gradient-to-br from-white to-slate-50 rounded-3xl border border-slate-200 p-6 shadow-lg">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div v-for="feature in productFeatures" :key="feature.label" class="flex items-center gap-3 p-3 bg-white rounded-xl border border-slate-100">
                  ...
                  <div>
                    <div class="font-medium text-slate-900">{{ feature.label }}</div>
                    <div class="text-sm text-slate-600">{{ feature.value }}</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="lg:col-span-5">
          <div class="sticky top-8 space-y-8">
            ...
            <div>
              ...
              <!-- Title -->
              <h1 class="text-3xl lg:text-4xl font-bold text-slate-900 leading-tight mb-4">
                {{ product.name }}
              </h1>
              ...
              <div class="flex items-center gap-4 mb-6">
                <div class="flex items-center gap-1">
                  <div class="flex items-center">
                    <svg v-for="i in 5" :key="i" class="w-5 h-5" :class="i <= 4 ? 'text-yellow-400' : 'text-slate-200'" fill="currentColor" viewBox="0 0 20 20">
                ...
                <button class="text-emerald-600 hover:text-emerald-700 font-medium transition-colors">
                  Voir les avis
                </button>
              </div>
            ...
            <!-- Pricing -->
            <div class="bg-gradient-to-br from-slate-50 to-emerald-50/50 rounded-3xl p-6 border border-slate-200">
              <div class="space-y-4">
                <div class="flex items-end gap-4">
                  ...
                  <div v-if="product.originalPrice" class="flex flex-col items-end">
                ...
                <div class="flex items-center justify-between text-sm">
                  ...
                  <div class="flex items-center gap-2" :class="{
                    ...
                    <div :class="{
                      'w-2 h-2 bg-green-500 rounded-full animate-pulse': product.inStock,
            ...
            <div class="space-y-6">
              ...
              <div>
                ...
                <div class="flex items-center bg-slate-100 rounded-2xl overflow-hidden w-fit">
                  <button 
                  ...
                  <span class="px-6 py-4 font-bold text-xl text-slate-900 min-w-[4rem] text-center bg-white">
                    {{ quantity }}
                  </span>
              ...
              <div class="space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                  ...
                  <button class="flex items-center justify-center gap-2 py-4 px-6 border-2 border-slate-300 hover:border-emerald-400 text-slate-700 hover:text-emerald-700 font-semibold rounded-2xl transition-all duration-300 hover:bg-emerald-50">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <!-- Bulk Options -->
              <div v-if="bulkOptions.length > 0" class="bg-white rounded-3xl border border-slate-200 p-6">
                <div class="flex items-center gap-3 mb-4">
                  ...
                  <h3 class="text-lg font-bold text-slate-900">Tarifs dégressifs</h3>
                </div>
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  ...
                  >
                    <div class="text-2xl font-bold text-slate-900 group-hover/bulk:text-emerald-700 mb-1">{{ option.quantity }}x</div>
                    <div class="text-lg font-semibold text-emerald-600 mb-1">{{ formatPrice(option.unitPrice) }}</div>
                    <div class="text-sm text-slate-500">{{ option.discount }}% de remise</div>
                  </button>
                </div>
              </div>
            </div>
            ...
            <div class="bg-slate-50 rounded-3xl p-6 border border-slate-200">
              ...
              <div class="space-y-3">
                <div class="flex items-center gap-3">
                  ...
                  <span class="text-slate-700">Garantie satisfait ou remboursé 30 jours</span>
                </div>
                <div class="flex items-center gap-3">
                  <svg class="w-5 h-5 text-emerald-600" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
      ...
      <div class="bg-white rounded-3xl border border-slate-200 shadow-xl overflow-hidden mb-16">
        <div class="border-b border-slate-200">
          <nav class="flex">
            <button
              ...
              :class="{
                'text-emerald-700 border-b-2 border-emerald-500 bg-emerald-50': activeTab === tab.id,
        ...
        <div class="p-8">
          ...
          <div v-if="activeTab === 'description'" class="prose prose-lg max-w-none">
            <h3 class="text-2xl font-bold text-slate-900 mb-6">Description détaillée</h3>
            <div class="text-slate-700 leading-relaxed space-y-4">
              <p>{{ product.description }}</p>
              <p>Ce produit de haute qualité est parfaitement adapté pour un usage scolaire intensive. Fabriqué avec des matériaux durables, il garantit une utilisation optimale tout au long de l'année scolaire.</p>
              <p>Nos produits sont rigoureusement testés et respectent toutes les normes de sécurité en vigueur. Ils sont conçus pour accompagner les étudiants dans leur parcours éducatif avec fiabilité et efficacité.</p>
            </div>
          </div>

          <!-- Specifications Tab -->
          <div v-if="activeTab === 'specs'" class="space-y-6">
            <h3 class="text-2xl font-bold text-slate-900">Spécifications techniques</h3>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div v-for="spec in productSpecs" :key="spec.label" class="flex justify-between items-center p-4 bg-slate-50 rounded-2xl">
          ...
          <div v-if="activeTab === 'reviews'" class="space-y-8">
            <div class="flex items-center justify-between">
              ...
              <button class="bg-emerald-600 text-white px-6 py-3 rounded-2xl font-semibold hover:bg-emerald-700 transition-colors">
                Écrire un avis
              </button>
            </div>
            
            <!-- Reviews Summary -->
            <div class="bg-gradient-to-br from-slate-50 to-emerald-50/30 rounded-3xl p-8 border border-slate-200">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="space-y-3">
                  <div v-for="rating in [5,4,3,2,1]" :key="rating" class="flex items-center gap-3">
                    ...
                    <span class="text-sm font-medium text-slate-500 w-12 text-right">{{ getRatingCount(rating) }} avis</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="space-y-6 mt-8">
              <div v-for="review in productReviews" :key="review.id" class="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
                <div class="flex items-center justify-between mb-2">
                  <div class="font-semibold text-slate-900">{{ review.user }}</div>
                  <div class="flex items-center">
                    <svg v-for="i in 5" :key="i" class="w-4 h-4" :class="i <= review.rating ? 'text-yellow-400' : 'text-slate-200'" fill="currentColor" viewBox="0 0 20 20">
                      <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                    </svg>
                  </div>
                </div>
  ...
  try {
    ...
    if (product.value.features && product.value.features.length > 0) {
      ...
      productFeatures.value = [
        ...
        { label: 'Disponibilité', value: product.value.inStock ? 'En stock' : 'Rupture de stock' }
      ]
    }
