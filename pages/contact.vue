            ...
            <form @submit.prevent="sendMessage" class="space-y-6">
              ...
              <div class="flex flex-col sm:flex-row gap-4">
                ...
                <button
                  ...
                  class="flex-1 bg-green-600 hover:bg-green-700 disabled:bg-gray-400 text-white font-semibold py-4 px-6 rounded-lg transition-all duration-200 transform hover:scale-105 flex items-center justify-center"
                  :title="
                    canSendWhatsApp
                      ? 'Envoyer sur WhatsApp'
                      : 'Remplissez le nom, sujet et message pour activer'
                  "
                >
                  <svg
                    class="w-5 h-5 mr-2"
                ...
                <button
                  type="button"
                  @click="testWhatsApp"
                  class="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded-lg text-sm"
                >
                  Test WhatsApp
                </button>
              </div>
