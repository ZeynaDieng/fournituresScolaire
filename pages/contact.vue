<template>
  <div class="min-h-screen">
    <!-- Hero Section -->
    <section
      class="relative min-h-[600px] bg-cover bg-center bg-fourniture-pattern overflow-hidden"
    >
      <!-- Background Image -->
      <div
        class="absolute inset-0 bg-cover bg-center"
        style="background-image: url('/images/fournitureBanniere.png')"
      ></div>
      ...
      <!-- Floating Elements -->
      <div
        class="absolute top-20 left-10 w-20 h-20 bg-white/10 rounded-full blur-xl animate-float"
      ></div>
      <div
        class="absolute top-40 right-20 w-32 h-32 bg-emerald-300/20 rounded-full blur-2xl animate-float-delayed"
      ></div>
      <div
        class="absolute bottom-20 left-1/4 w-16 h-16 bg-teal-300/30 rounded-full blur-lg animate-pulse"
      ></div>
      <div
        class="absolute top-1/3 right-10 w-12 h-12 bg-white/20 rounded-full animate-bounce"
      ></div>

      <!-- Content -->
      <div
        class="relative z-10 flex items-center justify-center min-h-[600px] px-4"
      >
        <div class="text-center text-white max-w-4xl mx-auto">
          <!-- Floating icon -->
          <div
            class="inline-flex items-center justify-center w-24 h-24 bg-white/20 rounded-full backdrop-blur-sm mb-8 animate-float border border-white/30"
          >
            <svg
          ...
          <h1
            class="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-white to-emerald-100 bg-clip-text text-transparent"
          >
            Contactez-nous
          </h1>
          <p
            class="text-xl md:text-2xl text-emerald-100 max-w-3xl mx-auto mb-12 leading-relaxed"
          >
            Une question ? Un besoin spécifique ? Notre équipe est là pour vous
            accompagner dans tous vos projets éducatifs
          </p>
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-2xl mx-auto">
            ...
            >
              <div class="text-3xl font-bold text-emerald-200 mb-2">24h</div>
              <div class="text-sm text-emerald-100">Réponse rapide</div>
            </div>
            <div
              class="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:bg-white/20 transition-all duration-300"
            >
              <div class="text-3xl font-bold text-emerald-200 mb-2">100%</div>
              <div class="text-sm text-emerald-100">Satisfaction</div>
            </div>
            <div
              class="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:bg-white/20 transition-all duration-300"
            >
              <div class="text-3xl font-bold text-emerald-200 mb-2">7j/7</div>
              <div class="text-sm text-emerald-100">Disponibilité</div>
            </div>
          </div>
        </div>
      </div>
