          ...
          <div class="bg-white rounded-2xl shadow-xl p-8">
            ...
            <form @submit.prevent="sendMessage" class="space-y-6">
              ...
              <button
                type="submit"
                :disabled="isLoading"
                class="w-full bg-green-700 disabled:bg-gray-400 text-white font-semibold py-4 px-6 rounded-lg transition-all duration-200 transform hover:scale-105 flex items-center justify-center"
              >
                <svg
                  v-if="isLoading"
