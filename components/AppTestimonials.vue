<template>
  <section
    class="relative py-20 bg-[#FBFBFA] overflow-hidden"
  >
    <!-- Background decoration -->
    <div class="absolute inset-0 opacity-30">
      <div
        class="absolute top-10 left-10 w-32 h-32 bg-[#0F3D91]/10 rounded-full blur-3xl"
      ></div>
      <div
        class="absolute bottom-10 right-10 w-40 h-40 bg-[#F4C542]/20 rounded-full blur-3xl"
      ></div>
    </div>
    ...
    <div class="container mx-auto px-4 relative z-10">
      ...
      <div class="text-center mb-16">
        <div
          class="eyebrow mb-4"
        >
          <svg class="w-4 h-4 text-[#0F3D91]" fill="currentColor" viewBox="0 0 20 20">
            <path
        ...
        <h2 class="text-3xl md:text-5xl font-display font-extrabold text-[#0F3D91] mb-4">
          Ce que disent nos
        ...
        <p class="text-lg text-slate-600 max-w-3xl mx-auto leading-relaxed">
          Des milliers de parents au Sénégal nous font confiance pour la rentrée de leurs enfants.
        </p>
      </div>
      ...
      <div class="relative max-w-6xl mx-auto">
        ...
        <div
          ...
          class="rounded-3xl bg-white border border-slate-200/80 p-8 shadow-soft"
        >
          <div class="animate-pulse">
            ...
            <div class="flex space-x-1 mt-4">
              <div
                v-for="n in 5"
                :key="n"
                class="w-4 h-4 bg-slate-200 rounded"
              ></div>
            </div>
          </div>
        </div>
        ...
        <div v-else class="relative overflow-hidden">
          <div
            class="rounded-3xl bg-white border border-slate-200/80 p-1 shadow-soft"
          >
            <div
          ...
          >
            <div
              ...
              :class="{
                ...
                'bg-slate-300 hover:bg-slate-400': currentTestimonial !== index,
              }"
            />
            <!-- Progress indicator for active dot -->
            <div
              v-if="currentTestimonial === index"
              class="absolute inset-0 w-3 h-3 rounded-full bg-[#0F3D91] animate-ping opacity-30"
            />
          </button>
        </div>
